...
<p align="center">
  <a href="https://github.com/kingsokafor777-droid?tab=repositories"><img src="https://img.shields.io/badge/PUBLIC%20REPOSITORIES-43-312E81?style=flat-square&logo=github&logoColor=white" alt="Public repositories" /></a>
</p>
...
> **Current state:** ⚙️ **Foundation, deterministic model, evidence governance, controls, risk-register signals, offline CCM adapter, sealed scenario corpus, payload-blind audit export, and synthetic console reference shipped; platform next.** [`cyrisk-core`](https://github.com/kingsokafor777-droid/cyrisk-core) v0.1.0, [`cyrisk-model`](https://github.com/kingsokafor777-droid/cyrisk-model) v0.1.0, [`cyrisk-evidence`](https://github.com/kingsokafor777-droid/cyrisk-evidence) v0.1.0, [`cyrisk-controls`](https://github.com/kingsokafor777-droid/cyrisk-controls) v0.1.0, [`cyrisk-register`](https://github.com/kingsokafor777-droid/cyrisk-register) v0.1.0, [`cyrisk-ccm`](https://github.com/kingsokafor777-droid/cyrisk-ccm) v0.1.0, [`cyrisk-scenarios`](https://github.com/kingsokafor777-droid/cyrisk-scenarios) v0.1.0, [`cyrisk-audit-export`](https://github.com/kingsokafor777-droid/cyrisk-audit-export) v0.1.0, and [`cyrisk-console`](https://github.com/kingsokafor777-droid/cyrisk-console) v0.1.0 are verified source releases with deterministic validation, successful hosted CI and CodeQL workflows, and protected `main` branches. Console is a source-release FastAPI/static-workbench reference over sealed synthetic records with demonstrative caller context; it does not authenticate identity, validate production authorization, connect to PostgreSQL, access live evidence, calculate risk, approve/accept decisions, verify remediation, or deploy a console. Repository 10 remains planned and is not public.
