...
<p align="center">
  <a href="https://github.com/kingsokafor777-droid?tab=repositories"><img src="https://img.shields.io/badge/PUBLIC%20REPOSITORIES-26-312E81?style=flat-square&logo=github&logoColor=white" alt="Public repositories" /></a>
</p>
...
> **Current state:** ⚙️ **Control foundation is in development.** [`ccm-core`](https://github.com/kingsokafor777-droid/ccm-core) v0.1.0 and [`ccm-controls`](https://github.com/kingsokafor777-droid/ccm-controls) v0.1.1 are shipped source releases with deterministic offline validation, successful hosted CI and CodeQL workflows, and protected `main` branches. They provide the contract, integrity, control-definition, and offline evaluation layers only; the remaining repository names below are planned and are **not yet public repositories**.
...
building:
  ...
  - Continuous Control Monitoring: deterministic AWS/Azure evidence-engineering platform; ccm-core v0.1.0 and ccm-controls v0.1.1 are shipped, with read-only cloud collection next
learning:
