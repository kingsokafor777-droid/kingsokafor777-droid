...
<p align="center">
  <a href="https://github.com/kingsokafor777-droid?tab=repositories"><img src="https://img.shields.io/badge/PUBLIC%20REPOSITORIES-37-312E81?style=flat-square&logo=github&logoColor=white" alt="Public repositories" /></a>
</p>
...
> **Current state:** ⚙️ **Foundation, deterministic model, and evidence governance shipped; control economics next.** [`cyrisk-core`](https://github.com/kingsokafor777-droid/cyrisk-core) v0.1.0, [`cyrisk-model`](https://github.com/kingsokafor777-droid/cyrisk-model) v0.1.0, and [`cyrisk-evidence`](https://github.com/kingsokafor777-droid/cyrisk-evidence) v0.1.0 are verified source releases with deterministic validation, successful hosted CI and CodeQL workflows, and protected `main` branches. Evidence records are payload-blind metadata, integrity, expiry, and review observations—not proof of source truth, reviewer authority, or a risk decision. Repositories 04–10 remain planned and are not public.
