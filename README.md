...
<p align="center">
  <a href="https://github.com/kingsokafor777-droid?tab=repositories"><img src="https://img.shields.io/badge/PUBLIC%20REPOSITORIES-42-312E81?style=flat-square&logo=github&logoColor=white" alt="Public repositories" /></a>
</p>
...
> **Current state:** ⚙️ **Foundation, deterministic model, evidence governance, controls, risk-register signals, offline CCM adapter, sealed scenario corpus, and payload-blind audit export shipped; console next.** [`cyrisk-core`](https://github.com/kingsokafor777-droid/cyrisk-core) v0.1.0, [`cyrisk-model`](https://github.com/kingsokafor777-droid/cyrisk-model) v0.1.0, [`cyrisk-evidence`](https://github.com/kingsokafor777-droid/cyrisk-evidence) v0.1.0, [`cyrisk-controls`](https://github.com/kingsokafor777-droid/cyrisk-controls) v0.1.0, [`cyrisk-register`](https://github.com/kingsokafor777-droid/cyrisk-register) v0.1.0, [`cyrisk-ccm`](https://github.com/kingsokafor777-droid/cyrisk-ccm) v0.1.0, [`cyrisk-scenarios`](https://github.com/kingsokafor777-droid/cyrisk-scenarios) v0.1.0, and [`cyrisk-audit-export`](https://github.com/kingsokafor777-droid/cyrisk-audit-export) v0.1.0 are verified source releases with deterministic validation, successful hosted CI and CodeQL workflows, and protected `main` branches. Audit Export packages declared metadata and verifies archive/manifest integrity offline; it does not retrieve raw evidence, execute redaction, validate source truth, render an audit opinion, certify compliance, validate authority, or make a risk/remediation decision. Repositories 09–10 remain planned and are not public.
